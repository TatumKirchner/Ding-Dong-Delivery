...
public class EngineAudio : MonoBehaviour
{
    ...
    private PlayerCarController m_CarController; // Reference to car we are controlling
    private IsPaused pauseManager;
    [Range(1f, 100f)] public float volume = 10f;
    ...
    private void StartSound()
    {
        ...
        m_CarController = GetComponent<PlayerCarController>();
